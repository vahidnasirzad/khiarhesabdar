...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/prisma.ts [app-route] (ecmascript)"); // 🚨 Ensure this path is correct for your project structure
;
;
async function POST(request) {
    try {
        ...
        const { date, title, description = '', amount, store_name = '', type, category = 'General', has_receipt = false, has_invoice = false } = data;
        // Basic validation check
        if (!title || !amount || !type) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Missing required fields: title, amount, and type are mandatory.'
            }, {
                status: 400
            });
        }
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: 'Failed to save invoice to the database.'
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7e5294e0._.js.map